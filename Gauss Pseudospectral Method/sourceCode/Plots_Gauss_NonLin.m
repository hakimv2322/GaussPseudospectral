%--------------------------------------------------------------------------
% Plots_Gauss_NonLin.m
% Plotting function, Gauss pseudospectral method
% For nonlinear example: Benson, et al., 2006
%--------------------------------------------------------------------------
%
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
function Plots_Gauss_NonLin(y,u,Lam,p,method)
    %----------------------------------------------------------------------
    ...
    Xopt = NonLin_Solution_Costate(T);
    plot(T,Xopt,'-','linewidth',2,'color',mycolor(6,:)); hold on
    ...
    Uopt = NonLin_Solution_Control(T);
